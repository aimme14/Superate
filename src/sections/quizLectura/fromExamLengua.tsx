import { Clock, ChevronRight, Send, Brain, AlertCircle, CheckCircle2, BookOpen, Play, Users, Timer, HelpCircle, Maximize, X, Database, ZoomIn, Shield } from "lucide-react"
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <CardFooter className="flex justify-center">
          <Button
            ...
            className="bg-blue-600 hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-500 hover:shadow-lg"
          >
            ...
            <div className="flex items-center justify-between gap-4 flex-wrap">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <h2 className={cn("text-sm font-normal", appTheme === 'dark' ? 'text-gray-300' : 'text-gray-600')}>{examConfig.module || examConfig.title}</h2>
                </div>
              </div>
