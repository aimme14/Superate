import { Clock, ChevronLeft, ChevronRight, Send, Brain, AlertCircle, CheckCircle2, BookOpen, Play, Users, Timer, HelpCircle, Maximize, X } from "lucide-react"
...
const examData = {
  ...
  instructions: [
    ...
    "El examen se realizará en pantalla completa para evitar distracciones"
  ],
  questions: [
    {
      id: 1,
