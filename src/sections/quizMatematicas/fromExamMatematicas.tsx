            ...
            <CardContent>
              ...
              >
                {currentQ.options.map((option) => (
                  <div
                    key={option.id}
                    className={`flex items-start space-x-3 ${theme.answerBorder} rounded-lg p-4 transition-all duration-200 relative overflow-hidden ${theme.answerBackground} ${theme.answerHover}`}
                    style={theme.pattern ? { 
