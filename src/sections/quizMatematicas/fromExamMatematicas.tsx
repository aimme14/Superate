import { Clock, ChevronRight, Send, Brain, AlertCircle, CheckCircle2, Calculator, Timer, HelpCircle, Users, Play, Maximize, Database, X, ZoomIn, Shield } from "lucide-react"
  ...
  useEffect(() => {
    ...
    const loadQuiz = async () => {
      ...
      try {
        ...
        const existingExam = await fetchExamResultDocument(userId, quiz.id, currentPhase, {
          subject: currentSubject,
