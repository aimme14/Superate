import { Clock, ChevronRight, Send, Brain, AlertCircle, CheckCircle2, FlaskConical, Timer, HelpCircle, Users, Play, Maximize, X, Database, ZoomIn, Shield } from "lucide-react"
...
const ExamWithFirebase = () => {
  ...
  const WelcomeScreen = () => {
    ...
    const theme = getQuizTheme('química')
    return (
