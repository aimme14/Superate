import { Clock, ChevronRight, Send, Brain, AlertCircle, CheckCircle2, Atom, Timer, HelpCircle, Users, Play, Maximize, X, Database, ZoomIn, Shield } from "lucide-react"
...
// Configuración del examen de Física
const examConfig = {
  subject: "Física",
  phase: "first" as const,
  examId: "exam_fisica_001", // ID único del examen
  title: "Examen de Física",
  description: "Evaluación de conocimientos en física y fenómenos naturales",
  module: "Módulo de Física",
};
...
const ExamWithFirebase = () => {
  ...
  useEffect(() => {
    ...
    const loadQuiz = async () => {
      console.log('=== INICIANDO CARGA DEL CUESTIONARIO DE FÍSICA ===');
    ...
    return (
      ...
      >
        ...
        <div className="w-full lg:w-56 flex-shrink-0">
          <div className={cn("border rounded-lg p-2.5 sticky top-4 shadow-sm", appTheme === 'dark' ? 'bg-zinc-800 border-zinc-700' : 'bg-white')}>
