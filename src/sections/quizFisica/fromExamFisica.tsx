import { Clock, ChevronRight, Send, Brain, AlertCircle, CheckCircle2, Atom, Timer, HelpCircle, Users, Play, Maximize, Database } from "lucide-react"
          ...
          <div className="bg-white border rounded-lg p-4 mb-6 shadow-sm">
            <div className="flex items-center gap-4">
              <div className="relative h-16 w-16 flex-shrink-0 rounded-md overflow-hidden">
                <Atom className="w-16 h-16 text-blue-500" />
              </div>
              <div>
