import { Clock, ChevronLeft, ChevronRight, Send, Brain, AlertCircle, CheckCircle2, BookCheck } from "lucide-react"
            ...
            <div className="bg-white border rounded-lg p-4 mb-6 shadow-sm">
              <div className="flex items-center gap-4">
                <div className="relative h-16 w-16 flex-shrink-0 rounded-md overflow-hidden">
                  <BookCheck className="w-16 h-16 text-amber-500" />
                </div>
                <div>
...
const examData = {
  ...
  description: "Evaluación de habilidades de comprensión lectora y gramática",
