...
export const SUBJECTS_CONFIG: Subject[] = [
  ...
  },
  {
    ...
    icon: '🇬🇧',
    topics: [
      { name: '¿Dónde puede ver estos avisos?', code: 'P1' },
      { name: 'Relacionar definiciones con palabras', code: 'P2' },
      { name: 'Completar conversaciones', code: 'P3' },
      { name: 'Texto largo con espacios', code: 'P4' },
      { name: 'Texto largo + preguntas de selección múltiple', code: 'P5' },
      { name: 'Texto largo + preguntas más profundas', code: 'P6' },
      { name: 'Texto con espacios en blanco', code: 'P7' },
    ],
  },
];
