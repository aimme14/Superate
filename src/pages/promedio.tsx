...
// ============================================
// FUNCIONES EXPORTADAS PARA USO EN OTROS COMPONENTES
// ============================================

// Función helper para obtener el trofeo y colores según el puesto
export const getRankTrophyAndColors = (rank: number) => {
  if (rank === 1) {
    return {
      trophy: '🏆',
      bgGradient: 'linear-gradient(135deg, #fef3c7 0%, #fde68a 100%)',
...
// Función helper para determinar el nivel de desempeño basado en el puntaje
export const getPerformanceLevel = (score: number): { level: string; definition: string } => {
  if (score >= 80) {
    return {
      level: 'Nivel Alto',
      definition: 'Demuestra dominio adecuado de las competencias evaluadas.'
...
// ============================================
// FUNCIONES EXPORTADAS PARA GENERACIÓN DE PDF
// ============================================
