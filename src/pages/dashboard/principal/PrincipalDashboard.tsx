  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-none bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-800 p-8 text-white shadow-2xl"
      >
        <div className="absolute inset-0 bg-gradient-to-r from-blue-600/50 via-cyan-500/50 to-indigo-800/50 animate-pulse" />
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                >
                  Bienvenido, {stats.coordinatorName}
                </motion.h1>
                <motion.p 
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              >
                ...
                <div className="text-xs opacity-75">Docentes</div>
              </motion.div>
              <motion.div
                whileHover={{ scale: 1.05, y: -5 }}
                className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center border border-white/20"
      ...
      <motion.div
        ...
        transition={{ delay: 0.2 }}
        className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-600 p-8 md:p-10 text-white shadow-2xl mx-4 md:mx-6 lg:mx-8"
      >
        ...
        <div className="relative z-10">
          <motion.div
            ...
            className="mb-6"
          >
            <h2 className="text-4xl font-bold mb-4">¡Hola Coordinador!</h2>
            <p className="text-lg opacity-90 leading-relaxed max-w-3xl">
              Bienvenido a tu panel de control de la sede <strong>{stats.campusName}</strong>. Aquí tienes toda la información de docentes y estudiantes de tu sede de un vistazo. Gestiona y supervisa con total facilidad.
            </p>
          </motion.div>
      ...
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.3 }}
        className="grid grid-cols-2 md:grid-cols-2 gap-4 mx-4 md:mx-6 lg:mx-8"
      >
        {[
          { icon: GraduationCap, label: 'Docentes', color: 'from-blue-500 to-blue-700', tab: 'docentes' },
          { icon: Users, label: 'Estudiantes', color: 'from-cyan-500 to-cyan-700', tab: 'estudiantes' },
        ].map((btn, index) => (
          <motion.div
            key={btn.label}
            initial={{ opacity: 0, y: 20 }}
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          {[
            ...
            <TabsTrigger
              ...
              value={tab.id}
              className={cn(
                "flex items-center gap-2 data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-600 data-[state=active]:to-indigo-600 data-[state=active]:text-white",
    ...
    <div className="space-y-6">
      <Card className={cn(theme === 'dark' ? 'bg-zinc-900 border-zinc-700' : 'bg-white border-gray-200')}>
        <CardHeader>
          ...
          <CardDescription>Listado completo de docentes de la sede</CardDescription>
        </CardHeader>
        <CardContent>
